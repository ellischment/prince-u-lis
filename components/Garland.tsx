...
// --green убран по просьбе студии: тёмно-зелёный на тёмно-синем фоне (--deep,
// --navy) почти не отличается от подложки, и флажок читается не как флажок, а
// как дырка в гирлянде. Особенно заметно там, где нить проходит по эмблеме.
// Остальные пять цветов те же, из палитры SPEC §12.
const COLORS = [
  "var(--fox)",
  "var(--gold)",
  "var(--sky)",
