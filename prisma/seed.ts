...
async function seedTexts(): Promise<void> {
  const texts: { key: string; value: unknown }[] = [
    { key: "hero.title", value: "Мастерская, где делают руками" },
    { key: "hero.subtitle", value: "Студия «Принц и Лис»" },
    {
      key: "hero.hand",
      value: "приходите как есть, фартук найдётся",
    },
    {
      key: "trust.items",
      value: [
        { title: "С нуля", text: "Опыт не нужен, мастер рядом всё занятие" },
        { title: "Всё своё", text: "Материалы, инструмент и обжиг включены" },
        { title: "В центре", text: "Сущёвская 12с1, каждый день с 11:00 до 22:00" },
      ],
    },
