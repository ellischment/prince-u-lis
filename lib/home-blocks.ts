...
// (форма записи строится на своём шаге — так решили в начале шага 2.1, чтобы не
// выдумывать логику вперёд шага). Здесь те, что уже готовы: первый экран,
// полоса доверия, анкета с каталогом занятий, расписание (врезка-тизер к
// /raspisanie), команда, работы, события, блог, отзывы, контакты.
