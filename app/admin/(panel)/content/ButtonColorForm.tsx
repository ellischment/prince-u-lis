  ...
  return (
    <form action={formAction} className={styles.form} noValidate>
      ...
      <p className={styles.note}>
        Цвет из палитры. Текст на кнопке подбирается автоматически как в макете: на оранжевом
        белый, на светлых заливках тёмный. По умолчанию — оранжевый, как основные кнопки в макете.
      </p>
